...
class ProductTemplate(models.Model):
    ...
    wxpp_recommend_id = fields.Many2one('wxapp.product.category', string='小程序商程推荐商品', ondelete='set null')
    characteristic = fields.Text('商品特色')
    recommend_status = fields.Boolean('是否推荐')
    wxapp_published = fields.Boolean('是否上架', default=False)
    ...
    def get_main_image(self):
        ...
        return '%s/web/image/product.template/%s/image/100x100'%(base_url, self.id)
